...
public interface ProductService {
	public abstract boolean insert(MultipartFile multipartFile, ProductDto productDto, String directoryPath,
			String datePath);

	public abstract boolean deleteByProductNum(Long productNum);

	public abstract boolean update(MultipartFile multipartFile, ProductDto productDto, String directoryPath,
			String datePath);
	...
	public abstract void upload(MultipartFile multipartFile, ProductDto productDto, String directoryPath,
			String datePath);
	...
	public abstract boolean updateProductIsRecommend(@Param("productNum") Long productNum,
			@Param("productIsRecommend") boolean productIsRecommend);

	public abstract List<ProductDto> findByYesterDay();

	public abstract void autoDeleteFiles(List<ProductDto> yesterdayProducts, String directoryPath,
